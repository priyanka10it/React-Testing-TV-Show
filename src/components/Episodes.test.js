...
import {render,queryByTestId,rerender} from '@testing-library/react';
...
test('Test component renders', () => {
    ...
    expect(queryByTestId('episodes')).toBeTruthy()
  })

  test('Test component renders data correctly',() => {
    const {rerender, queryByTestId} = render(<Episodes episodes={episodesData} />)
    expect(queryByTestId('episodes')).toBeTruthy()
  }) 